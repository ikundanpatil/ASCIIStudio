...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "ASCII Vibes Studio converts images and text into ASCII art, with a gallery for saved creations." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "ASCII Vibes Studio converts images and text into ASCII art, with a gallery for saved creations." },
