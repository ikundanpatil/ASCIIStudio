...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "ASCII Studio — Turn Images & Text into ASCII Art" },
      { name: "twitter:description", content: "Convert images and text into beautiful ASCII art right in your browser. Customize, save, and share — completely free." },
